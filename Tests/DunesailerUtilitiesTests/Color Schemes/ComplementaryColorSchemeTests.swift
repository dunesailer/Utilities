//  Created by B.T. Franklin on 8/25/17.

import XCTest
@testable import DunesailerUtilities

class ComplementaryColorSchemeTests: XCTestCase {
    ...
    func testHSBAInitializer() {
        let testThemeHSBAColor = HSBAColor(hue: CGFloat(0.99),
                                            ...
                                            alpha: CGFloat(1.0))
        let testColorScheme = ComplementaryColorScheme(themeColor: testThemeHSBAColor)
    ...
    func testGetColors() {
        ...
        let testColorScheme = ComplementaryColorScheme(themeColor: testThemeColor.hsbaColor)
        ...
        XCTAssertEqual(1.00, testColors[2].brightnessComponent, accuracy: 0.00001)
        XCTAssertEqual(1.00, testColors[2].alphaComponent, accuracy: 0.00001)
        
        XCTAssertEqual(0.49, testColors[3].hueComponent, accuracy: 0.00001)
        XCTAssertEqual(1.00, testColors[3].saturationComponent, accuracy: 0.00001)
        XCTAssertEqual(0.50, testColors[3].brightnessComponent, accuracy: 0.00001)
        XCTAssertEqual(1.00, testColors[3].alphaComponent, accuracy: 0.00001)

        XCTAssertEqual(0.49, testColors[4].hueComponent, accuracy: 0.00001)
