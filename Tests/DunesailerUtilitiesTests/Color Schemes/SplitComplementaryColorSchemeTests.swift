...
class SplitComplementaryColorSchemeTests: XCTestCase {
    ...
    func testGetColors() {
        ...
        XCTAssertEqual(0.54, testColors[3].hueComponent, accuracy: 0.00001)
        ...
        XCTAssertEqual(0.44, testColors[4].hueComponent, accuracy: 0.00001)
