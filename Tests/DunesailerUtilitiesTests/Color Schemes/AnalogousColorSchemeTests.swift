...
class AnalogousColorSchemeTests: XCTestCase {
    ...
    func testHSBAInitializer() {
        let testThemeHSBAColor = HSBAColor(hue: CGFloat(0.99),
                                           ...
                                           alpha: CGFloat(1.0))
        let testColorScheme = AnalogousColorScheme(themeColor: testThemeHSBAColor)
    ...
    func testGetColors() {
        ...
        let testColorScheme = AnalogousColorScheme(themeColor: testThemeColor.hsbaColor)
        ...
        XCTAssertEqual(1.00, testColors[2].hueComponent, accuracy: 0.00001)
        ...
        XCTAssertEqual(0.85, testColors[3].hueComponent, accuracy: 0.00001)
        XCTAssertEqual(0.75, testColors[3].saturationComponent, accuracy: 0.00001)
        XCTAssertEqual(0.75, testColors[3].brightnessComponent, accuracy: 0.00001)
        XCTAssertEqual(1.00, testColors[3].alphaComponent, accuracy: 0.00001)
        
        XCTAssertEqual(0.80, testColors[4].hueComponent, accuracy: 0.00001)
