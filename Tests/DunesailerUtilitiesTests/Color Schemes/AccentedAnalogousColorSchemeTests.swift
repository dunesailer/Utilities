...
class AccentedAnalogousColorSchemeTests: XCTestCase {
    ...
    func testHSBAInitializer() {
        let testThemeHSBAColor = HSBAColor(hue: CGFloat(0.99),
                                           ...
                                           alpha: CGFloat(1.0))
        let testColorScheme = AccentedAnalogousColorScheme(themeColor: testThemeHSBAColor)
    ...
    func testGetColors() {
        ...
        let testColorScheme = AccentedAnalogousColorScheme(themeColor: testThemeColor.hsbaColor)
