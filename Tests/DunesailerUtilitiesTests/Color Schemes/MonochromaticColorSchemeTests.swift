...
class MonochromaticColorSchemeTests: XCTestCase {
    ...
    func testHSBAInitializer() {
        let testThemeHSBAColor = HSBAColor(hue: CGFloat(0.99),
                                           ...
                                           alpha: CGFloat(1.0))
        let testColorScheme = MonochromaticColorScheme(themeColor: testThemeHSBAColor)
    ...
    func testGetColors() {
        ...
        let testColorScheme = MonochromaticColorScheme(themeColor: testThemeColor.hsbaColor)
        ...
        XCTAssertEqual(0.30, testColors[1].brightnessComponent, accuracy: 0.00001)
        ...
        XCTAssertEqual(0.50, testColors[2].saturationComponent, accuracy: 0.00001)
        ...
        XCTAssertEqual(0.50, testColors[3].saturationComponent, accuracy: 0.00001)
        XCTAssertEqual(0.30, testColors[3].brightnessComponent, accuracy: 0.00001)
